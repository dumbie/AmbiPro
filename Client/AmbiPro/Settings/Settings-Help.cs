        ...
        void Load_Help_Text()
        {
            try
            {
                ...
                if (sp_Help_Text.Children.Count == 0)
                {
                    ...
                    sp_Help_Text.Children.Add(new TextBlock() { Text = "AmbiPro captures your screen and based on the screenshot it calculates which colors need to be displayed on the leds, due to this it is a pretty resourceful application.", Style = (Style)App.Current.Resources["TextBlockGray"], TextWrapping = TextWrapping.Wrap });
                    ...
                    sp_Help_Text.Children.Add(new TextBlock() { Text = "Depending on your Arduino board's memory (RAM) only a certain maximum amount of leds can be displayed due to the low memory limitations.", Style = (Style)App.Current.Resources["TextBlockGray"], TextWrapping = TextWrapping.Wrap });

                    sp_Help_Text.Children.Add(new TextBlock() { Text = "\r\nHow can I quickly turn the leds on or off?", Style = (Style)App.Current.Resources["TextBlockBlack"] });
                    sp_Help_Text.Children.Add(new TextBlock() { Text = "You can click on the tray icon with your middle mouse button to quickly switch the leds on or off.", Style = (Style)App.Current.Resources["TextBlockGray"], TextWrapping = TextWrapping.Wrap });

                    sp_Help_Text.Children.Add(new TextBlock() { Text = "\r\nWhere can I find the required drivers?", Style = (Style)App.Current.Resources["TextBlockBlack"] });
                    sp_Help_Text.Children.Add(new TextBlock() { Text = "If you are an Arduino user you can install the drivers by installing the Arduino IDE software found on the official website: https://arduino.cc", Style = (Style)App.Current.Resources["TextBlockGray"], TextWrapping = TextWrapping.Wrap });

                    sp_Help_Text.Children.Add(new TextBlock() { Text = "\r\nSupport and bug reporting", Style = (Style)App.Current.Resources["TextBlockBlack"] });
                    sp_Help_Text.Children.Add(new TextBlock() { Text = "When you are walking into any problems or a bug you can go to my help page at https://help.arnoldvink.com so I can try to help you out and get everything working.", Style = (Style)App.Current.Resources["TextBlockGray"], TextWrapping = TextWrapping.Wrap });

                    sp_Help_Text.Children.Add(new TextBlock() { Text = "\r\nDeveloper donation", Style = (Style)App.Current.Resources["TextBlockBlack"] });
                    sp_Help_Text.Children.Add(new TextBlock() { Text = "If you appreciate my project and want to support me with my projects you can make a donation through https://donation.arnoldvink.com", Style = (Style)App.Current.Resources["TextBlockGray"], TextWrapping = TextWrapping.Wrap });

                    //Set the version text
                    sp_Help_Text.Children.Add(new TextBlock() { Text = "\r\nApplication made by Arnold Vink", Style = (Style)App.Current.Resources["TextBlockBlack"] });
                    sp_Help_Text.Children.Add(new TextBlock() { Text = "Version: v" + AVFunctions.ApplicationVersion(), Style = (Style)App.Current.Resources["TextBlockGray"], TextWrapping = TextWrapping.Wrap });
                }
            }
            catch { }
        }
